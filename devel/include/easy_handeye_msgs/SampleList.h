...
struct Printer< ::easy_handeye_msgs::SampleList_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::easy_handeye_msgs::SampleList_<ContainerAllocator>& v)
  {
    ...
    if (v.hand_world_samples.empty() || false)
      s << "[";
    for (size_t i = 0; i < v.hand_world_samples.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::geometry_msgs::Transform_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.hand_world_samples[i]);
    }
    if (v.hand_world_samples.empty() || false)
      s << "]";
    ...
    if (v.camera_marker_samples.empty() || false)
      s << "[";
    for (size_t i = 0; i < v.camera_marker_samples.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::geometry_msgs::Transform_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.camera_marker_samples[i]);
    }
    if (v.camera_marker_samples.empty() || false)
      s << "]";
  }
